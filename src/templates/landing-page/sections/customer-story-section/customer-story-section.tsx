...
const customerStories = [
  ...
  {
    content: 'Transformar minha ideia em uma loja online foi fácil e rápido. Adorei as opções de personalização e a simplicidade para gerenciar ps pedidos. Já vejo meus produtos alcançando mais pessoas.',
    author: {
      name: 'Jacob Jones',
      role: 'CEO na JJ Corp',
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {customerStories.map((customerStory) => (
            <div key={customerStory.author.name} className="flex flex-col gap-6 rounded-lg bg-gray-500 p-6 md:p-12">
              <p className="text-body-md font-thin text-balance text-gray-200 italic">{customerStory.content}</p>
